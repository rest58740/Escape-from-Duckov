...
{
	// Token: 0x06000A9F RID: 2719 RVA: 0x0002DF84 File Offset: 0x0002C184
	public override PipeRenderer.OrientedPoint[] GenerateShape()
	{
		float num = this.bevelSize;
		Vector2 vector;
		vector..ctor(-this.size.x / 2f + num, this.size.y / 2f - num);
	...
	// Token: 0x06000AA0 RID: 2720 RVA: 0x0002E41C File Offset: 0x0002C61C
