...
public class Breakable : MonoBehaviour
{
	...
	// (get) Token: 0x060001EE RID: 494 RVA: 0x00009754 File Offset: 0x00007954
	...
	// Token: 0x060001F0 RID: 496 RVA: 0x0000988E File Offset: 0x00007A8E
	private void OnValidate()
	{
	}

	// Token: 0x060001F1 RID: 497 RVA: 0x00009890 File Offset: 0x00007A90
	private void OnHurt(DamageInfo dmgInfo)
	{
		...
		case Breakable.BreakableStates.normal:
			if (this.simpleHealth.HealthValue <= (float)this.dangerHealth)
			{
				...
				if (this.dangerFx)
				{
					Object.Instantiate<GameObject>(this.dangerFx, base.transform.position, base.transform.rotation);
				}
			}
			break;
	...
	// Token: 0x060001F2 RID: 498 RVA: 0x00009928 File Offset: 0x00007B28
	...
	// Token: 0x060001F3 RID: 499 RVA: 0x000099F2 File Offset: 0x00007BF2
