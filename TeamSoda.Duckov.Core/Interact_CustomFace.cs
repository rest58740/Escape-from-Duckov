...
public class Interact_CustomFace : InteractableBase
{
	...
	public void CopyToClipboard()
	{
		...
		NotificationText.Push(LocalizationManager.ToPlainText(this.OnCopyNotificationKey));
	}
	...
	public void PastyDataAndApply()
	{
		...
		if (CustomFaceSettingData.JsonToData(GUIUtility.systemCopyBuffer, out saveData))
		{
			...
			NotificationText.Push(LocalizationManager.ToPlainText(this.OnPastySuccessNotificationKey));
			return;
		}
		NotificationText.Push(LocalizationManager.ToPlainText(this.OnPastyFailedNotificationKey));
	}
