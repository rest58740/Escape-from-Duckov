...
public class GameCamera : MonoBehaviour
{
	...
	// (get) Token: 0x060001D1 RID: 465 RVA: 0x00008BF4 File Offset: 0x00006DF4
	...
	// (get) Token: 0x060001D2 RID: 466 RVA: 0x00008C06 File Offset: 0x00006E06
	...
	// Token: 0x060001D3 RID: 467 RVA: 0x00008C10 File Offset: 0x00006E10
	private void Start()
	{
		...
		if (!this.dofComponent && this.mainVCam)
		{
			...
			profile.TryGet<DepthOfField>(ref this.dofComponent);
		}
	}

	// Token: 0x060001D4 RID: 468 RVA: 0x00008C74 File Offset: 0x00006E74
	private void Update()
	{
		if (!this.target)
		{
	...
	// Token: 0x060001D5 RID: 469 RVA: 0x00008CF0 File Offset: 0x00006EF0
	...
	// Token: 0x060001D6 RID: 470 RVA: 0x00008E44 File Offset: 0x00007044
	...
	// Token: 0x060001D7 RID: 471 RVA: 0x00008E8F File Offset: 0x0000708F
	public void ForceSyncPos()
	{
		this.UpdatePosition(1f);
	}

	// Token: 0x060001D8 RID: 472 RVA: 0x00008E9C File Offset: 0x0000709C
	public void SetTarget(CharacterMainControl _target)
	{
		this.target = _target;
	}

	// Token: 0x060001D9 RID: 473 RVA: 0x00008EA8 File Offset: 0x000070A8
	...
	// Token: 0x060001DA RID: 474 RVA: 0x00008F18 File Offset: 0x00007118
	...
	// Token: 0x060001DB RID: 475 RVA: 0x00009050 File Offset: 0x00007250
	...
	// Token: 0x060001DC RID: 476 RVA: 0x00009268 File Offset: 0x00007468
	...
	// Token: 0x060001DD RID: 477 RVA: 0x000093B0 File Offset: 0x000075B0
	private Vector3 ScreenPointToCharacterPlane(Vector3 screenPoint)
	{
		Plane plane;
		plane..ctor(Vector3.up, this.target.transform.position + Vector3.up * 0.5f);
	...
	// Token: 0x060001DE RID: 478 RVA: 0x00009414 File Offset: 0x00007614
