...
public class CustomFaceUIColorPicker : MonoBehaviour
{
	...
	public void Init(CustomFaceUI _master, string titleKey)
	{
		...
		if (!this.created)
		{
			...
			{
				Color color2;
				color2..ctor(color.r, color.g, color.b, 1f);
				CustomFaceUIColorPickerButton customFaceUIColorPickerButton = Object.Instantiate<CustomFaceUIColorPickerButton>(this.singleButton, this.buttonParent);
	...
	private void UpdateSelection()
	{
		...
		{
			customFaceUIColorPickerButton.SetSelection(TMPro_ExtensionMethods.CompareRGB(customFaceUIColorPickerButton.Color, this.currentColor));
		}
	}
