...
public class AICharacterController : MonoBehaviour
{
	...
	public void Init(CharacterMainControl _characterMainControl, Vector3 patrolCenter, AudioManager.VoiceType voiceType = AudioManager.VoiceType.Duck, AudioManager.FootStepMaterialType footStepMatType = AudioManager.FootStepMaterialType.organic)
	{
		...
		this.scatterMultiplierModifier = new Modifier(200, this.scatterModifierMultiplier, this);
		this.scatterMultiplierStat.AddModifier(this.scatterMultiplierModifier);
		if (this.hasSkill && !this.skillInstance && this.skillPfb)
		{
			this.skillInstance = Object.Instantiate<SkillBase>(this.skillPfb, base.transform);
	...
	public ItemSetting_Skill GetItemSkill(bool random)
	{
		...
		{
			int index = Random.Range(0, this.skillsOnItem.Count);
	...
	private void Update()
	{
		...
		if (this.leader != null && this.searchedEnemy == null)
		{
			this.patrolPosition = this.leader.transform.position;
		}
		if (this.forceTracePlayerDistance > 0.5f && CharacterMainControl.Main != null && this.characterMainControl != null && Team.IsEnemy(this.characterMainControl.Team, Teams.player) && Vector3.Distance(base.transform.position, CharacterMainControl.Main.transform.position) < this.forceTracePlayerDistance)
		{
	...
	// Token: 0x0600018F RID: 399 RVA: 0x00007E54 File Offset: 0x00006054
	...
	// Token: 0x06000190 RID: 400 RVA: 0x00007EC0 File Offset: 0x000060C0
	private void OnEnable()
	{
		AIMainBrain.OnSoundSpawned += this.OnSound;
	}

	// Token: 0x06000191 RID: 401 RVA: 0x00007ED3 File Offset: 0x000060D3
	private void OnDisable()
	{
		AIMainBrain.OnSoundSpawned -= this.OnSound;
	}

	// Token: 0x06000192 RID: 402 RVA: 0x00007EE8 File Offset: 0x000060E8
	...
	// Token: 0x06000193 RID: 403 RVA: 0x00007F4C File Offset: 0x0000614C
	...
	// Token: 0x06000194 RID: 404 RVA: 0x0000803C File Offset: 0x0000623C
	...
	// Token: 0x06000195 RID: 405 RVA: 0x000080D8 File Offset: 0x000062D8
	...
	// Token: 0x06000196 RID: 406 RVA: 0x00008109 File Offset: 0x00006309
	...
	// Token: 0x06000198 RID: 408 RVA: 0x00008152 File Offset: 0x00006352
	public bool HasPath()
	{
		return this.pathControl.path != null;
	}

	// Token: 0x06000199 RID: 409 RVA: 0x00008162 File Offset: 0x00006362
	public bool WaitingForPathResult()
	{
		return this.pathControl.WaitingForPathResult;
	}

	// Token: 0x0600019A RID: 410 RVA: 0x0000816F File Offset: 0x0000636F
	public void StopMove()
	{
		this.pathControl.StopMove();
	}

	// Token: 0x0600019B RID: 411 RVA: 0x0000817C File Offset: 0x0000637C
	public bool IsMoving()
	{
		return this.pathControl.Moving;
	}

	// Token: 0x0600019C RID: 412 RVA: 0x00008189 File Offset: 0x00006389
	public bool ReachedEndOfPath()
	{
		return this.pathControl.ReachedEndOfPath;
	}

	// Token: 0x0600019D RID: 413 RVA: 0x00008196 File Offset: 0x00006396
	public void SetTarget(Transform _aimTarget)
	{
		this.aimTarget = _aimTarget;
	}

	// Token: 0x0600019E RID: 414 RVA: 0x0000819F File Offset: 0x0000639F
	...
	// Token: 0x0600019F RID: 415 RVA: 0x000081D8 File Offset: 0x000063D8
	...
	// Token: 0x060001A0 RID: 416 RVA: 0x00008208 File Offset: 0x00006408
