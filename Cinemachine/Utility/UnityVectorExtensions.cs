...
namespace Cinemachine.Utility
{
	...
	{
		// Token: 0x060003F0 RID: 1008 RVA: 0x00017FBB File Offset: 0x000161BB
		public static bool IsNaN(this Vector2 v)
		{
			return float.IsNaN(v.x) || float.IsNaN(v.y);
		}

		// Token: 0x060003F1 RID: 1009 RVA: 0x00017FD7 File Offset: 0x000161D7
		public static bool IsNaN(this Vector3 v)
		{
			return float.IsNaN(v.x) || float.IsNaN(v.y) || float.IsNaN(v.z);
		}

		// Token: 0x060003F2 RID: 1010 RVA: 0x00018000 File Offset: 0x00016200
		...
		// Token: 0x060003F3 RID: 1011 RVA: 0x00018040 File Offset: 0x00016240
		...
		// Token: 0x060003F4 RID: 1012 RVA: 0x0001807E File Offset: 0x0001627E
		public static Vector3 ProjectOntoPlane(this Vector3 vector, Vector3 planeNormal)
		{
			return vector - Vector3.Dot(vector, planeNormal) * planeNormal;
		}

		// Token: 0x060003F5 RID: 1013 RVA: 0x00018094 File Offset: 0x00016294
		...
		// Token: 0x060003F6 RID: 1014 RVA: 0x000180D4 File Offset: 0x000162D4
		...
		// Token: 0x060003F7 RID: 1015 RVA: 0x000182F1 File Offset: 0x000164F1
		private static float Cross(this Vector2 v1, Vector2 v2)
		{
			return v1.x * v2.y - v1.y * v2.x;
		}

		// Token: 0x060003F8 RID: 1016 RVA: 0x0001830E File Offset: 0x0001650E
		public static Vector2 Abs(this Vector2 v)
		{
			return new Vector2(Mathf.Abs(v.x), Mathf.Abs(v.y));
		}

		// Token: 0x060003F9 RID: 1017 RVA: 0x0001832B File Offset: 0x0001652B
		public static Vector3 Abs(this Vector3 v)
		{
			return new Vector3(Mathf.Abs(v.x), Mathf.Abs(v.y), Mathf.Abs(v.z));
		}

		// Token: 0x060003FA RID: 1018 RVA: 0x00018353 File Offset: 0x00016553
		public static bool IsUniform(this Vector2 v)
		{
			return Math.Abs(v.x - v.y) < 0.0001f;
		}

		// Token: 0x060003FB RID: 1019 RVA: 0x0001836E File Offset: 0x0001656E
		public static bool IsUniform(this Vector3 v)
		{
			return Math.Abs(v.x - v.y) < 0.0001f && Math.Abs(v.x - v.z) < 0.0001f;
		}

		// Token: 0x060003FC RID: 1020 RVA: 0x000183A4 File Offset: 0x000165A4
		public static bool AlmostZero(this Vector3 v)
		{
			return v.sqrMagnitude < 9.999999E-09f;
		}

		// Token: 0x060003FD RID: 1021 RVA: 0x000183B4 File Offset: 0x000165B4
		...
		// Token: 0x060003FE RID: 1022 RVA: 0x000183EC File Offset: 0x000165EC
		...
		// Token: 0x060003FF RID: 1023 RVA: 0x00018438 File Offset: 0x00016638
		...
		// Token: 0x06000400 RID: 1024 RVA: 0x0001846C File Offset: 0x0001666C
		...
		// Token: 0x06000401 RID: 1025 RVA: 0x00018498 File Offset: 0x00016698
