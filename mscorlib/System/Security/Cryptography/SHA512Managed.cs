...
namespace System.Security.Cryptography
{
	...
	{
		// Token: 0x06003063 RID: 12387 RVA: 0x000B03C0 File Offset: 0x000AE5C0
		...
		// Token: 0x06003064 RID: 12388 RVA: 0x000B0419 File Offset: 0x000AE619
		...
		// Token: 0x06003065 RID: 12389 RVA: 0x000B0449 File Offset: 0x000AE649
		...
		// Token: 0x06003066 RID: 12390 RVA: 0x000B0454 File Offset: 0x000AE654
		[SecuritySafeCritical]
		...
		// Token: 0x06003067 RID: 12391 RVA: 0x000B045C File Offset: 0x000AE65C
		...
		// Token: 0x06003068 RID: 12392 RVA: 0x000B04FC File Offset: 0x000AE6FC
		[SecurityCritical]
		...
		// Token: 0x06003069 RID: 12393 RVA: 0x000B0628 File Offset: 0x000AE828
		[SecurityCritical]
		...
		// Token: 0x0600306A RID: 12394 RVA: 0x000B071C File Offset: 0x000AE91C
		[SecurityCritical]
		...
		// Token: 0x0600306B RID: 12395 RVA: 0x000B02A1 File Offset: 0x000AE4A1
		private static ulong RotateRight(ulong x, int n)
		{
			return x >> n | x << 64 - n;
		}

		// Token: 0x0600306C RID: 12396 RVA: 0x000B02B3 File Offset: 0x000AE4B3
		private static ulong Ch(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ ((x ^ ulong.MaxValue) & z);
		}

		// Token: 0x0600306D RID: 12397 RVA: 0x000AFB1A File Offset: 0x000ADD1A
		private static ulong Maj(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x0600306E RID: 12398 RVA: 0x000B0A39 File Offset: 0x000AEC39
		private static ulong Sigma_0(ulong x)
		{
			return SHA512Managed.RotateRight(x, 28) ^ SHA512Managed.RotateRight(x, 34) ^ SHA512Managed.RotateRight(x, 39);
		}

		// Token: 0x0600306F RID: 12399 RVA: 0x000B0A55 File Offset: 0x000AEC55
		private static ulong Sigma_1(ulong x)
		{
			return SHA512Managed.RotateRight(x, 14) ^ SHA512Managed.RotateRight(x, 18) ^ SHA512Managed.RotateRight(x, 41);
		}

		// Token: 0x06003070 RID: 12400 RVA: 0x000B0A71 File Offset: 0x000AEC71
		private static ulong sigma_0(ulong x)
		{
			return SHA512Managed.RotateRight(x, 1) ^ SHA512Managed.RotateRight(x, 8) ^ x >> 7;
		}

		// Token: 0x06003071 RID: 12401 RVA: 0x000B0A86 File Offset: 0x000AEC86
		private static ulong sigma_1(ulong x)
		{
			return SHA512Managed.RotateRight(x, 19) ^ SHA512Managed.RotateRight(x, 61) ^ x >> 6;
		}

		// Token: 0x06003072 RID: 12402 RVA: 0x000B0AA0 File Offset: 0x000AECA0
		[SecurityCritical]
