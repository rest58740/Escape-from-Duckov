...
namespace System.Security.Cryptography
{
	...
	{
		// Token: 0x0600303B RID: 12347 RVA: 0x000AF4C4 File Offset: 0x000AD6C4
		...
		// Token: 0x0600303C RID: 12348 RVA: 0x000AF51A File Offset: 0x000AD71A
		...
		// Token: 0x0600303D RID: 12349 RVA: 0x000AF54A File Offset: 0x000AD74A
		protected override void HashCore(byte[] rgb, int ibStart, int cbSize)
		{
			this._HashData(rgb, ibStart, cbSize);
		}

		// Token: 0x0600303E RID: 12350 RVA: 0x000AF555 File Offset: 0x000AD755
		protected override byte[] HashFinal()
		{
			return this._EndHash();
		}

		// Token: 0x0600303F RID: 12351 RVA: 0x000AF560 File Offset: 0x000AD760
		...
		// Token: 0x06003040 RID: 12352 RVA: 0x000AF5E0 File Offset: 0x000AD7E0
		...
		// Token: 0x06003041 RID: 12353 RVA: 0x000AF6F4 File Offset: 0x000AD8F4
		...
		// Token: 0x06003042 RID: 12354 RVA: 0x000AF7E0 File Offset: 0x000AD9E0
		[SecurityCritical]
		...
		// Token: 0x06003043 RID: 12355 RVA: 0x000AFAFD File Offset: 0x000ADCFD
		private static uint RotateRight(uint x, int n)
		{
			return x >> n | x << 32 - n;
		}

		// Token: 0x06003044 RID: 12356 RVA: 0x000AFB0F File Offset: 0x000ADD0F
		private static uint Ch(uint x, uint y, uint z)
		{
			return (x & y) ^ ((x ^ uint.MaxValue) & z);
		}

		// Token: 0x06003045 RID: 12357 RVA: 0x000AFB1A File Offset: 0x000ADD1A
		private static uint Maj(uint x, uint y, uint z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x06003046 RID: 12358 RVA: 0x000AFB27 File Offset: 0x000ADD27
		private static uint sigma_0(uint x)
		{
			return SHA256Managed.RotateRight(x, 7) ^ SHA256Managed.RotateRight(x, 18) ^ x >> 3;
		}

		// Token: 0x06003047 RID: 12359 RVA: 0x000AFB3D File Offset: 0x000ADD3D
		private static uint sigma_1(uint x)
		{
			return SHA256Managed.RotateRight(x, 17) ^ SHA256Managed.RotateRight(x, 19) ^ x >> 10;
		}

		// Token: 0x06003048 RID: 12360 RVA: 0x000AFB55 File Offset: 0x000ADD55
		private static uint Sigma_0(uint x)
		{
			return SHA256Managed.RotateRight(x, 2) ^ SHA256Managed.RotateRight(x, 13) ^ SHA256Managed.RotateRight(x, 22);
		}

		// Token: 0x06003049 RID: 12361 RVA: 0x000AFB70 File Offset: 0x000ADD70
		private static uint Sigma_1(uint x)
		{
			return SHA256Managed.RotateRight(x, 6) ^ SHA256Managed.RotateRight(x, 11) ^ SHA256Managed.RotateRight(x, 25);
		}

		// Token: 0x0600304A RID: 12362 RVA: 0x000AFB8C File Offset: 0x000ADD8C
		[SecurityCritical]
