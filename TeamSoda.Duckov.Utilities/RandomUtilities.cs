...
namespace Duckov.Utilities
{
	...
	{
		// Token: 0x0600006B RID: 107 RVA: 0x000032CC File Offset: 0x000014CC
		...
		// Token: 0x0600006C RID: 108 RVA: 0x00003310 File Offset: 0x00001510
		...
		// Token: 0x0600006D RID: 109 RVA: 0x00003344 File Offset: 0x00001544
		...
		// Token: 0x0600006E RID: 110 RVA: 0x0000337C File Offset: 0x0000157C
		...
		public static T GetRandomWeighted<T>(this IList<T> list, Func<T, float> weightFunction, float lowPercent = 0f)
		{
			...
			float num2 = 0f;
			float num3 = Random.Range(num * lowPercent, num);
