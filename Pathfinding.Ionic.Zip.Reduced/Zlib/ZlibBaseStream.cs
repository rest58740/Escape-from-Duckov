...
namespace Pathfinding.Ionic.Zlib
{
	...
	{
		// Token: 0x06000438 RID: 1080 RVA: 0x0001DB98 File Offset: 0x0001BD98
		...
		// (get) Token: 0x06000439 RID: 1081 RVA: 0x0001DC0C File Offset: 0x0001BE0C
		internal int Crc32
		{
			get
			{
		...
		// (get) Token: 0x0600043A RID: 1082 RVA: 0x0001DC28 File Offset: 0x0001BE28
		...
		// (get) Token: 0x0600043B RID: 1083 RVA: 0x0001DC34 File Offset: 0x0001BE34
		private ZlibCodec z
		{
			get
			{
		...
		// (get) Token: 0x0600043C RID: 1084 RVA: 0x0001DCB0 File Offset: 0x0001BEB0
		...
		// Token: 0x0600043D RID: 1085 RVA: 0x0001DCE0 File Offset: 0x0001BEE0
		...
		// Token: 0x0600043E RID: 1086 RVA: 0x0001DE98 File Offset: 0x0001C098
		private void finish()
		{
			if (this._z == null)
			{
		...
		// Token: 0x0600043F RID: 1087 RVA: 0x0001E23C File Offset: 0x0001C43C
		private void end()
		{
			if (this.z == null)
			{
		...
		// Token: 0x06000440 RID: 1088 RVA: 0x0001E284 File Offset: 0x0001C484
		...
		// Token: 0x06000441 RID: 1089 RVA: 0x0001E2E8 File Offset: 0x0001C4E8
		public override void Flush()
		{
			this._stream.Flush();
		}

		// Token: 0x06000442 RID: 1090 RVA: 0x0001E2F8 File Offset: 0x0001C4F8
		public override long Seek(long offset, SeekOrigin origin)
		{
			throw new NotImplementedException();
		}

		// Token: 0x06000443 RID: 1091 RVA: 0x0001E300 File Offset: 0x0001C500
		public override void SetLength(long value)
		{
			this._stream.SetLength(value);
		}

		// Token: 0x06000444 RID: 1092 RVA: 0x0001E310 File Offset: 0x0001C510
		...
		// Token: 0x06000445 RID: 1093 RVA: 0x0001E38C File Offset: 0x0001C58C
		...
		// Token: 0x06000446 RID: 1094 RVA: 0x0001E4C8 File Offset: 0x0001C6C8
		...
		// (get) Token: 0x06000447 RID: 1095 RVA: 0x0001E7D8 File Offset: 0x0001C9D8
		...
		// (get) Token: 0x06000448 RID: 1096 RVA: 0x0001E7E8 File Offset: 0x0001C9E8
		...
		// (get) Token: 0x06000449 RID: 1097 RVA: 0x0001E7F8 File Offset: 0x0001C9F8
		...
		// (get) Token: 0x0600044A RID: 1098 RVA: 0x0001E808 File Offset: 0x0001CA08
		...
		// (get) Token: 0x0600044B RID: 1099 RVA: 0x0001E818 File Offset: 0x0001CA18
		// (set) Token: 0x0600044C RID: 1100 RVA: 0x0001E820 File Offset: 0x0001CA20
		...
		// Token: 0x0600044D RID: 1101 RVA: 0x0001E828 File Offset: 0x0001CA28
		...
		// Token: 0x0600044E RID: 1102 RVA: 0x0001E87C File Offset: 0x0001CA7C
		...
		// Token: 0x06000450 RID: 1104 RVA: 0x0001E988 File Offset: 0x0001CB88
