...
namespace Pathfinding.Ionic.Zip
{
	...
	{
		// Token: 0x06000260 RID: 608 RVA: 0x0000EBD4 File Offset: 0x0000CDD4
		...
		// Token: 0x06000261 RID: 609 RVA: 0x0000EE84 File Offset: 0x0000D084
		...
		// Token: 0x06000262 RID: 610 RVA: 0x0000EEF4 File Offset: 0x0000D0F4
		...
		// Token: 0x06000263 RID: 611 RVA: 0x0000F1AC File Offset: 0x0000D3AC
		private static byte[] GenZip64EndOfCentralDirectory(long StartOfCentralDirectory, long EndOfCentralDirectory, int entryCount, uint numSegments)
		{
			...
			Array.Copy(bytes, 0, array, num, 4);
			num += 4;
			uint num5 = (numSegments != 0U) ? (numSegments - 1U) : 0U;
		...
		// Token: 0x06000264 RID: 612 RVA: 0x0000F2F0 File Offset: 0x0000D4F0
